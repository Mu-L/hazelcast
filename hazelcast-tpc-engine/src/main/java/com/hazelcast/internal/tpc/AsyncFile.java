...
public abstract class AsyncFile {
    ...
    public abstract Fut<Integer> fsync();

    public abstract Fut<Integer> fdatasync();

    public abstract Fut<Integer> fallocate(int mode, long offset, long len);

    public abstract Fut<Integer> delete();

    public abstract Fut<Integer> open(int flags, int permissions);

    public abstract Fut<Integer> close();
     ...
     */
    public abstract Fut<Integer> pread(long offset, int length, long bufferAddress);
     ...
     * @return a Fut with the response code of the request.
     */
    public abstract Fut<Integer> pwrite(long offset, int length, long bufferAddress);

    public abstract Fut<Integer> pwrite(long offset, int length, long bufferAddress, int flags, int rwFlags);
}
