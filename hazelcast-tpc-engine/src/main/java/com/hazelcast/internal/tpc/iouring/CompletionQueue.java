...
public final class CompletionQueue {
    ...
    private static final int OFFSET_CQE_USERDATA = 0;
    private static final int OFFSET_CQE_RES = 8;
    private static final int OFFSET_CQE_FLAGS = 12;
    ...
    private int localTail;

    private long headAddr;
    private long tailAddr;
    private long cqesAddr;
