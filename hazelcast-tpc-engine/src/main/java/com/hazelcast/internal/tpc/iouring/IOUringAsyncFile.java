...
public final class IOUringAsyncFile extends AsyncFile {
    ...
    IOUringAsyncFile(String path, IOUringEventloop eventloop) {
        ...
        this.storageScheduler = eventloop.storageScheduler;
    ...
    @Override
    public Fut<Integer> fallocate(int mode, long offset, long len) {
        return dev.schedule(this, IORING_OP_FALLOCATE, 0, 0, len, mode, offset);
    }

    @Override
    public Fut<Integer> delete() {
