...
#include "include/com_hazelcast_internal_tpc_iouring_Socket.h"
...
Java_com_hazelcast_internal_tpc_iouring_Socket_toInetSocketAddress(JNIEnv* env, jclass this_class,
                                                                   jlong addr, jlong l){
...
Java_com_hazelcast_internal_tpc_iouring_Socket_initNative(JNIEnv* env, jclass this_class){
...
Java_com_hazelcast_internal_tpc_iouring_Socket_socket(JNIEnv* env, jclass this_class, jint type,
                                                      jint domain, jint protocol){
    return socket(type, domain, protocol);
}

JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_listen(JNIEnv* env, jclass this_class, jint sock_fd,
                                                      jint backlog){
...
JNIEXPORT jint JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_bind(JNIEnv* env, jclass this_class, jint sock_fd,
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_connect(JNIEnv *env, jclass this_class, jint sock_fd,
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_setTcpNoDelay(JNIEnv *env, jclass this_class, jint sock_fd,
                                                             jboolean tcpNoDelay){
...
Java_com_hazelcast_internal_tpc_iouring_Socket_isTcpNoDelay(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_setSendBufferSize(JNIEnv* env, jclass this_class, jint sock_fd,
                                                                 jint sendBufferSize){
...
JNIEXPORT jint JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_getSendBufferSize(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_setReceiveBufferSize(JNIEnv* env, jclass this_class, jint sock_fd,
...
JNIEXPORT jint JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_getReceiveBufferSize(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT jboolean JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_isReuseAddress(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_setReuseAddress(JNIEnv* env, jclass this_class, jint sock_fd,
...
JNIEXPORT jboolean JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_isReusePort(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_setReusePort(JNIEnv* env, jclass this_class, jint sock_fd,
                                                            jboolean reusePort){
...
JNIEXPORT jboolean JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_isKeepAlive(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_setKeepAlive(JNIEnv* env, jclass this_class, jint sock_fd,
                                                            jboolean keepAlive){
...
JNIEXPORT jint JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_getTcpKeepAliveTime(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_setTcpKeepAliveTime(JNIEnv* env, jclass this_class, jint sock_fd,
...
JNIEXPORT jint JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_getTcpKeepaliveIntvl(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_setTcpKeepaliveIntvl(JNIEnv* env, jclass this_class, jint sock_fd,
...
JNIEXPORT jint JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_getTcpKeepaliveProbes(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_setTcpKeepAliveProbes(JNIEnv* env, jclass this_class, jint sock_fd,
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_setSoLinger(JNIEnv* env, jclass this_class, jint sock_fd,
                                                           jint soLinger){
...
JNIEXPORT jint JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_getSoLinger(JNIEnv* env, jclass this_class, jint sock_fd){
    struct linger option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT jobject JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_getLocalAddress(JNIEnv* env, jclass this_class, jint sock_fd){
...
JNIEXPORT jobject JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_getRemoteAddress(JNIEnv* env, jclass this_class, jint sock_fd){
    struct sockaddr_storage addr;
    socklen_t addr_len = sizeof(addr);
...
JNIEXPORT jint JNICALL
Java_com_hazelcast_internal_tpc_iouring_Socket_setBlocking(JNIEnv* env, jclass this_class, jint socketfd){
    int old_flags = fcntl(socketfd, F_GETFL, 0);
    if (old_flags < 0){
        return old_flags;
    }

    int new_flags = old_flags & ~O_NONBLOCK;
    return fcntl(socketfd, F_SETFL, new_flags);
}
